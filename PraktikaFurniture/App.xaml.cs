        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            var host = new HostBuilder()
                .ConfigureServices((context, services) =>
                {
                    ...
                    {
                        options.UseSqlServer("Server=localhost;Database=testDB;UserName=postgres;Password=password");
                    });
                })
                .Build();
            ...
            using (var serviceScope = host.Services.CreateScope())
            {
                ...
                try
                {
                    var dbContext = serviceProvider.GetRequiredService<JewelryStoreDbContext>();
